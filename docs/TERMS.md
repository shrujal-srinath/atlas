...
## Your account
You are responsible for keeping your login secure and for activity under your
account. You may delete your account at any time from within the app.

## Acceptable use
Don't misuse the app: no attempting to breach security or access other users'
data, no automated scraping, no unlawful use.

## Availability & changes
The app and its features may change or be unavailable from time to time. We may
...
and we are not liable for any loss arising from its use or from reliance on its
data.
